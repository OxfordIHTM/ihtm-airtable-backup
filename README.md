...
[![test backup
workflow](https://github.com/OxfordIHTM/ihtm-airtable-backup/actions/workflows/test-backup-workflow.yml/badge.svg)](https://github.com/OxfordIHTM/ihtm-airtable-backup/actions/workflows/test-backup-workflow.yml)
[![deploy backup
workflow](https://github.com/OxfordIHTM/ihtm-airtable-backup/actions/workflows/deploy-backup-workflow.yml/badge.svg)](https://github.com/OxfordIHTM/ihtm-airtable-backup/actions/workflows/deploy-backup-workflow.yml)
<!-- badges: end -->

This repository is a
[`{targets}`](https://docs.ropensci.org/targets/)-based,
[`{renv}`](https://rstudio.github.io/renv/articles/renv.html)-enabled
[`R`](https://cran.r-project.org/) workflow for creating daily backups
of Oxford IHTM’s [Airtable](https://airtable.com/) bases.
...
- `_targets.R` file defines the steps in the workflow’s data ingest,
  data processing, data archiving pipeline.
...
This workflow was built using `R 4.6.1`. It uses the `renv` framework to
record R package dependencies and versions. Packages and versions used
are recorded in `renv.lock` and code used to manage dependencies is in
`renv/` and other files in the root project directory. On starting an R
session in the working directory, run `renv::restore()` to install R
package dependencies.

## Automation

This workflow uses [GitHub Actions](https://github.com/features/actions)
to orchestrate the automation of the daily backups. The GitHub Actions
workflow runs on a locally-managed runner maintained by the Oxford IHTM
project team hence data is kept within the team’s purview and
governance. Backups are currently created daily at 17:00 GMT.
